		...
		setGroundMaterials(new HashMap<Material, Double>() {
			{
				...
				put(Material.GRAVEL, 3.0d);
				put(Material.CLAY, 1.0d);
			}
		});
		setWallMaterials(new HashMap<Material, Double>() {
			{
				put(Material.LIGHT_GRAY_STAINED_GLASS, 1.0d);
				put(Material.BLUE_STAINED_GLASS, 1.0d);
				put(Material.CYAN_STAINED_GLASS, 1.0d);
				put(Material.LIGHT_BLUE_STAINED_GLASS, 1.0d);
			}
		});
